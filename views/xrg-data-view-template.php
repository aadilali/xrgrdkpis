                                ...
                                foreach($weeklyLaborData as $laborData) :
                                    ...
                                    <?php foreach($laborData['xrg_locations'] as $location) : ?>
                                        <tr class="weekly-content">
                                            ...
                                            //Temp Variables for calculations
                                            $forecastedSaleTemp = is_numeric($laborData[$location]['forecasted_sales']) ?: 0;
                                            $forecastedLaborTemp = is_numeric($laborData[$location]['forecasted_labor']) ?: 0;
                                            $bdgtLaborTemp = is_numeric($laborData[$location]['budgeted_labor']) ?: 0;
                                            $differenceForecastTemp = $forecastedLaborTemp - $bdgtLaborTemp;
                                            $theoLaborTemp = is_numeric($laborData[$location]['theo_labor']) ?: 0;
                                            $schedHoursTemp = is_numeric($laborData[$location]['scheduled_leader_hours']) ?: 0;
                                            $bdgtHoursTemp = is_numeric($laborData[$location]['budgeted_leader_hours']) ?: 0;
                                            ...
                                            $differenceForecast += $differenceForecastTemp;
                                            $theoLabor += $theoLaborTemp;
                                            $schedHours += $schedHoursTemp;
                                            $bdgtHours += $bdgtHoursTemp;
                                            $differenceHours += $differenceHoursTemp;
                                            ?>
                                    ...
                                    <tr class="total-bg">
                                        ...
                                        <td><?php echo XrgHelperFunctions::xrgFormatValue($forecastedLabor, 'percentage'); ?></td>
                                        <td><?php echo XrgHelperFunctions::xrgFormatValue($bdgtLabor, 'percentage'); ?></td>
                                        <td><?php echo XrgHelperFunctions::xrgFormatValue($differenceForecast, 'percentage'); ?></td>
                                        <td><?php echo XrgHelperFunctions::xrgFormatValue($theoLabor, 'percentage'); ?></td>
                                        <td><?php echo $schedHours; ?></td>
                                        <td><?php echo $bdgtHours; ?></td>
                                        <td><?php echo XrgHelperFunctions::xrgFormatValue($differenceHours, 'abs-numeric'); ?></td>
                                    </tr>
                                    <!--  Empty Row  -->
                                    <tr class="empty-row">
                                        <td colspan="9"></td>
